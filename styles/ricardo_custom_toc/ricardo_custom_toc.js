(requirejs.specified('base/js/namespace') ? define : function(deps, callback) {
    ...
    return define('nbextensions/ricardo_custom_toc/ricardo_custom_toc', deps, callback);
    ...
    //hover_highlight: '#C0C0C0', grey
    //selected_highlight: '#FFD700', yellow
    //running_highlight: '#FF0000', red
    //wrapper_background: '#FFFFFF', white
    //sidebar_border: '#EEEEEE', grey
    //navigate_text: '#333333', dark grey
    //navigate_num: '#000000', black
    //on_scroll: '#2447f0', royal blue
    // '#E2ECF2', pale blue
    // '#0070C0', // Ricardo blue
    ...
    var read_config = function () {
        ...
        $.extend(true, cfg, IPython.notebook.config.data.ricardo_custom_toc);
    ...
    try {
        ...
        console.log('[ricardo_custom_toc] working in non-live notebook'); //, err);
            ...
            events.on("before_save.Notebook",
                function() {
                    try {
                        ...
                        console.log("[ricardo_custom_toc] Error in metadata (navigation menu) - Proceeding", e)
                    }
                })
        }
    ...
    var show_settings_dialog = function (cfg, st) {
        ...
        $('<div class="modal-header">')
            ...
            .append('<h4 class="modal-title">ToC settings</h4>')
...
if (!requirejs.specified('base/js/namespace')) {
    window.table_of_contents = function(cfg, st) {
        ...
        // actual call is made
        requirejs(['nbextensions/ricardo_custom_toc/ricardo_custom_toc'], function(ricardo_custom_toc) {
            ricardo_custom_toc.table_of_contents(cfg, st);
        });
    };
}
